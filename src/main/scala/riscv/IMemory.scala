...
class IMemory extends Module {
    ...
    Memory.write(5.U, "b0000000_00101_00001_010_00011_0000011".U)//LW x3,5(x1) result 5+6=11 memory(11)=20
    Memory.write(6.U, "b0000000_00010_00001_010_00011_0100011".U)//SW x2,3(x1) result 3+6=9 memory(10)=5
